...
$sql="INSERT INTO menu(item_id,item_name, description, price, category_id, image,availability) VALUES ('$item_id','$name','$desc','$price','$Category','$Image','YES')"; 
