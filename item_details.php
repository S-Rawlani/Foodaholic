...
echo "<table class='table'><tr><td></td><td></td><td></td><td></td></tr>";
...
while($row = mysqli_fetch_array($result)){
  ...
  //echo "$row["item_name"]";
  echo "<tr><td>". $row["item_name"] ."</td><td>". $row["description"]."</td><td>". $row["price"]."</td><td><a href = 'cart.php?item_id=".$row["item_id"]."'>Add to Cart</a></td></tr>";
}
