        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="menu.php" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Orders</a>
...
<input type="submit" class= "btn-warning btn btn-primary p-2 px-xl-4 py-xl-2" value="Search">
</form>
...
echo "<table class='table table-striped'><tr><td>Name</td><td>Description</td><td>Price</td><td></td><td></td></tr>";

while($row = mysqli_fetch_array($result)){

  echo "<tr><td>". $row["item_name"] ."</td><td>". $row["description"]."</td><td>". $row["price"]."</td><td><a href = 'item_details.php?item_id=".$row["item_id"]."'>Details</a></td><td><a href = 'cart.php?item_id=".$row["item_id"]."'>Add to Cart</a></td></tr>";
}
